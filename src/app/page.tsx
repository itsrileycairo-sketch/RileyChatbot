  ...
  return (
    <div className="min-h-screen font-sans bg-transparent text-slate-800 dark:text-slate-100 transition-colors duration-700 overflow-x-hidden selection:bg-cyan-500/40 selection:text-white">
      ...
      <main className="relative z-10 w-full overflow-x-hidden flex flex-col">
        ...
        {/* 🔥 HERO SECTION — DITAMBAH OVERFLOW-HIDDEN ANTI BOCOR */}
        ...
        {/* 🔥 ABOUT SECTION — DITAMBAH OVERFLOW-HIDDEN ANTI BOCOR */}
        ...
        {/* 🔥 GITHUB STATS SECTION (Dimasukkan ke sini!) */}
        ...
        {/* 🔥 SERVICES & GLOBE SECTION — DITAMBAH OVERFLOW-HIDDEN ANTI BOCOR */}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full max-w-7xl relative z-10">
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 sm:gap-8 w-full">
              <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full">
                {[
                  { icon: Layout, title: "Frontend Dev", desc: "Membangun antarmuka yang indah, interaktif, dan responsif.", delay: 0.1, gradient: "from-cyan-400/20 to-blue-400/20" },
                  { icon: Database, title: "Backend Dev", desc: "Merancang arsitektur server dan database yang kokoh dan scalable.", delay: 0.2, gradient: "from-purple-400/20 to-pink-400/20" },
                  { icon: Smartphone, title: "Mobile First", desc: "Memastikan pengalaman yang sempurna di setiap perangkat dan layar.", delay: 0.3, gradient: "from-emerald-400/20 to-cyan-400/20" },
                  { icon: Code, title: "Clean Code", desc: "Menulis kode yang rapi, mudah dibaca, terstruktur, dan scalable.", delay: 0.4, gradient: "from-orange-400/20 to-rose-400/20" }
                ].map((service, i) => (
                  <ScrollReveal key={i} delay={service.delay} direction="up">
                    <div className="group p-5 sm:p-6 lg:p-7 rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] bg-white/25 dark:bg-slate-900/25 backdrop-blur-2xl border border-white/35 dark:border-white/[0.07] hover:border-cyan-400/40 dark:hover:border-cyan-400/30 transition-all duration-500 hover:-translate-y-1 sm:hover:-translate-y-2 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.06),0_0_0_1px_rgba(255,255,255,0.15)_inset] dark:shadow-[0_4px_20px_-10px_rgba(0,0,0,0.3),0_0_0_1px_rgba(255,255,255,0.03)_inset] hover:shadow-[0_16px_40px_-15px_rgba(6,182,212,0.15),0_0_0_1px_rgba(255,255,255,0.25)_inset] w-full h-full">
                      <div className={`w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br ${service.gradient} dark:bg-black/40 border border-white/40 dark:border-cyan-500/15 text-cyan-600 dark:text-cyan-300 flex items-center justify-center mb-3 sm:mb-4 lg:mb-5 group-hover:scale-110 group-hover:bg-gradient-to-br group-hover:from-cyan-500 group-hover:to-purple-500 group-hover:text-white group-hover:border-transparent transition-all duration-400 shadow-md group-hover:shadow-lg group-hover:shadow-purple-500/30`}>
                        <service.icon size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7" strokeWidth={1.8} />
                      </div>
                      <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-1.5 sm:mb-2 tracking-tight">{service.title}</h3>
                      <p className="text-slate-500 dark:text-slate-400 text-xs sm:text-sm leading-relaxed font-light tracking-wide">{service.desc}</p>
                    </div>
                  </ScrollReveal>
                ))}
              </div>
        ...
        {/* 🔥 CTA SECTION — DITAMBAH OVERFLOW-HIDDEN ANTI BOCOR */}
